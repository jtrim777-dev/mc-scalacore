...
import com.silver.metalmagic.screens.{GraphicsContext, ScreenBounds}
...
object ScreenTank {
  val OverlayTexture: ResourceLocation = "metalmagic:textures/gui/components/tank_overlay.png".rloc
  val TankWidth = 18
  val TankHeight = 51
}